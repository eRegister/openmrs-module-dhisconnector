...
public class DHISAttributeCombo {
    ...
    private List<DHISAttributeOptionCombo> attributeOptionCombos = new ArrayList<DHISAttributeOptionCombo>();
     ...
     */
    @JsonProperty("categoryOptionCombos")
    public List<DHISAttributeOptionCombo> getAttributeOptionCombos() {
     ...
     */
    @JsonProperty("categoryOptionCombos")
    public void setAttributeOptionCombos(List<DHISAttributeOptionCombo> attributeOptionCombos) {
